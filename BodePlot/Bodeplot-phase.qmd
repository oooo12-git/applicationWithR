...
PHASEforBodePlot3 = function(freqHz){
  ...
  ph_fr1 = (df_fr1[which.min(df_fr1[,3]),1] - df_fr1[which.min(df_fr1[,2]),1]) * freq
  ph_fr2 = (df_fr2[which.min(df_fr2[,3]),1] - df_fr2[which.min(df_fr2[,2]),1]) * freq
  ph_fr3 = (df_fr3[which.min(df_fr3[,3]),1] - df_fr3[which.min(df_fr3[,2]),1]) * freq
  ph_fr4 = (df_fr4[which.min(df_fr4[,3]),1] - df_fr4[which.min(df_fr4[,2]),1]) * freq
...
ggplot(data1, aes(freq,phaseDegree)) + geom_point() + geom_smooth()
```
